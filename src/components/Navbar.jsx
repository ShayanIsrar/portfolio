...
const Navbar = () => {
  ...
  const content = (
    <>
      <div className="lg:hidden block absolute top-16 w-full left-0 right-0 bg-slate-500">
        <ul className="text-center text-xl p-20">
          <Link spy={true} smooth={true} to="/">
            <li className="my-4 py-4 border-b border-slate-700 hover:bg-slate-600 hover:rounded">Home</li>
          </Link>
          <Link spy={true} smooth={true} to="/About">
            <li className="my-4 py-4 border-b border-slate-700 hover:bg-slate-600 hover:rounded">About</li>
          </Link>
          <Link spy={true} smooth={true} to="/Services">
            <li className="my-4 py-4 border-b border-slate-700 hover:bg-slate-600 hover:rounded">Services</li>
          </Link>
          <Link spy={true} smooth={true} to="/Projects">
            <li className="my-4 py-4 border-b border-slate-700 hover:bg-slate-600 hover:rounded">Projects</li>
          </Link>
          <Link spy={true} smooth={true} to="/Contact">
            <li className="my-4 py-4 border-b border-slate-700 hover:bg-slate-600 hover:rounded">Contact</li>
          </Link>
        </ul>
      </div>
    </>
    ...
    <nav className="sticky top-0">
      <div className="h-10vh flex justify-between z-50 text-white lg:py-5 px-20 py-4 border-b border-slate-800">
        <div className="flex items-center  flex-1">
          <span className="text-3xl font-bold text-fuchsia-600">SHAYAN ISRAR</span>
        </div>
        <div className="lg:flex md:flex lg: flex-1 items-center justify-end font-normal hidden">
          <div className="flex-10 ">
          <ul className="flex gap-8 mr-16 text-[19px]">
          <Link spy={true} smooth={true} to="/">
